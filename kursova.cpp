...
int main() {
    ...
    while (!isReady) {
        ...
        /*
            - АЛГОРИТЪМ - за провеждане на валидация на входна информация от страна на потребителя
        */
        if(arrayLength < 5){
            throw runtime_error("Съжелявам, числото трябва да е повече от 5.");
        } else if(arrayLength > 50){
            throw runtime_error("Съжелявам, числото трябва да е по-малко от 50.");
        }
